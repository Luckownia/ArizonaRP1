       ...
       //Change light-mode
            ...
            inputCheckbox.addEventListener("click", () => {
                    ...
                    if (logoPalm.src.endsWith("palm-tree-48.png")) {
                        logoPalm.src = "img/blackpalm.png";
                    } else {
                        logoPalm.src = "img/palm-tree-48.png";
                    }
           ...
           // Cursor
            ...
            const switchMode = document.querySelector(".switch-mode input")
            const photo = document.querySelector(".logo img");
            const poraDnia = document.querySelector(".span-circle img");
            ...
            const switchModeAll = document.querySelectorAll(".switch-mode input");
            const currentTheme = localStorage.getItem("theme");
            let theme = "dark";
            switchMode.addEventListener("click", function(){
                document.body.classList.toggle("darkmode");
                circle.classList.toggle("span-transform");
                if(switchMode.value=="on"){
                if(poraDnia.src.endsWith("sun.png")){
                    poraDnia.src = "img/moon.png";
                    photo.src =  "img/palm-tree-48.png";
                    theme = "dark"
                }
                    else if(poraDnia.src.endsWith("moon.png")){
                    poraDnia.src = "img/sun.png";
            ...
            window.addEventListener("scroll", function(){
                if (window.scrollY > sectionSec.offsetTop) {
                            sectionSec.classList.add("right-side");
                        }
            })
            window.addEventListener("scroll", function(){
                if (window.scrollY + 400 > sekcjaFor.offsetTop) {
                            sectionFor.classList.add("right-side");
                        }
            })
            window.addEventListener("scroll", function(){
                if(window.scrollY > sectionThr.offsetTop + 1000) {
